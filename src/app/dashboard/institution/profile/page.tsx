...
export default function InstitutionProfilePage() {
  ...
  if (loading) return <div className="border-2 border-black bg-[#eae3cb] p-6 font-mono shadow-[4px_4px_0px_0px_#1a1a14]">Loading profile...</div>;
  ...
  return (
    <div className="space-y-6 font-mono text-[#1a1a14]">
      <div className="border-2 border-black bg-[#eae3cb] shadow-[4px_4px_0px_0px_#1a1a14] p-4 flex items-center justify-between">
        <div>
          <h1 className="text-lg sm:text-xl font-black uppercase tracking-tight flex items-center gap-2">
            <Building2 className="h-5 w-5 text-[#e28774]" /> Institution Profile
          </h1>
      ...
      <div className="border-2 border-black bg-[#eae3cb] shadow-[4px_4px_0px_0px_#1a1a14] p-4 sm:p-6">
          ...
          {fields.map((f) => (
            <div key={f.key}>
              ...
              <input
                ...
                className="w-full border-2 border-black bg-[#f4ebd0] p-2 text-xs font-bold disabled:opacity-50 disabled:cursor-not-allowed"
              />
            </div>
          ))}
        </div>
