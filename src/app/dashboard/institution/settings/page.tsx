...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6 font-mono text-[var(--text-primary)]">
      <div className="border-2 border-[var(--border-primary)] bg-[var(--bg-secondary)] shadow-[4px_4px_0px_0px_var(--border-primary)] p-4 flex items-center justify-between">
        <div>
          <h1 className="text-lg sm:text-xl font-black uppercase tracking-tight flex items-center gap-2">
            <Settings className="h-5 w-5 text-[var(--accent)]" /> Institution Settings
          </h1>
      ...
      {saved && <div className="border-2 border-[var(--border-primary)] bg-green-200 text-green-900 p-3 text-xs font-black shadow-[3px_3px_0px_0px_var(--border-primary)]">Settings saved successfully.</div>}

      <div className="border-2 border-[var(--border-primary)] bg-[var(--bg-secondary)] shadow-[4px_4px_0px_0px_var(--border-primary)] p-4 sm:p-6 space-y-4">
